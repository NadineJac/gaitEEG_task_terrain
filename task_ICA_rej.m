function task_ICA_rej(sii, PATH, cfg)
% reject eye ICs
...
% - identify ICs labeled as >90% probability of being eye
% - reject and store updated dataset in PATHOUT
%
...
for si = sii % loop through all subjects
    ...
    % output file
    file_out = fullfile(PATHOUTsi,[ID,'_ICArej.set']); % file
    % report files
