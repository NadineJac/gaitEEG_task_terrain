function task_rawERSP_sensor(sii, PATH, cfg)
...
for si = sii % loop through all subjects
    ...
    % output file
    file_out = fullfile(PATHOUTsi,[ID,'_rawERSP_sensor.mat']); % file
    file_out_group = fullfile(PATHOUT,['sub-all_rawERSP_sensor.mat']); % file
